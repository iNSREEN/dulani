...
//             <span className="bg-gradient-to-r from-secondary via-primary to-secondary bg-clip-text text-transparent">{t('teamHeading')}</span>
//           </h2>
...
const TeamSection = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      nameKey: "nsreenAlfaifi", 
      roleKey: "coFounder",
      image: `${base}lovable-uploads/abf50def-8340-4f0f-831e-c1e73e5b3ec1.png`,
      linkedinUrl: "https://www.linkedin.com/in/nsreen-alfaifi/"
    },
    {
      nameKey: "shekhaAlabduslam",
      roleKey: "coFounder",
      image: `${base}lovable-uploads/41f8fbe8-82c0-42fa-9bf0-4b9b822c384e.png`,
      linkedinUrl: "https://www.linkedin.com/in/shekha-alabdulsalam"
    },
    {
      nameKey: "shadenAlmashuq",
      roleKey: "coFounder",
      image: `${base}lovable-uploads/b3dc2372-c162-466a-8fe0-99bb7e11bac4.png`,
      linkedinUrl: "https://www.linkedin.com/in/shaden-talal/"
    },
    {
      // nameKey: "lujainAlahrbi",
