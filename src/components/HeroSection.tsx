    ...
    <section id="hero" className={`pt-16 sm:pt-20 md:pt-24 pb-0 min-h-screen flex items-center relative overflow-hidden ${language === 'ar' ? 'bg-white' : 'bg-gradient-to-br from-background via-primary/5 to-background'}`}>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 xl:gap-16 items-center">
          {/* Left Side - Text + CTA */}
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left rtl:lg:text-right order-2 lg:order-1 relative z-20">
            ...
            <div className="flex justify-center lg:justify-start relative z-30">
              <InterestForm>
                <Button 
                  variant="demo" 
                  className="text-base sm:text-lg w-full sm:w-auto relative z-30"
                >
                  {t('joinInterestList')}
                </Button>
              </InterestForm>
          ...
          <div className="relative order-1 lg:order-2 z-10">
            <div className="flex justify-center items-center space-x-1 sm:space-x-2 md:space-x-3 rtl:space-x-reverse scale-75 sm:scale-90 md:scale-100">
              ...
              <div className="relative transform -rotate-12 rtl:rotate-12 hover:rotate-0 transition-transform duration-500">
                <div className="w-[112px] h-[242px] sm:w-[128px] sm:h-[277px] md:w-[144px] md:h-[312px] lg:w-[160px] lg:h-[346px] xl:w-[176px] xl:h-[381px] bg-black rounded-[16px] sm:rounded-[20px] md:rounded-[24px] lg:rounded-[28px] p-1 sm:p-1.5 shadow-lg">
