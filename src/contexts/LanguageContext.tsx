...
const translations = {
  ...
  ar: {
    ...
    aboutDescription: "دلني هو نظام إرشاد ذكي يعتمد على تقنية الواقع المعزز (AR) لتوجيه الزوار داخل المساحات الكبيرة والمعقدة. يتيح للمستخدمين التنقل بسهولة والوصول إلى وجهاتهم من خلال إرشادات مرئية تفاعلية عبر الهاتف، مما يعزز تجربة الزائر ويقلل من الازدحام ويوفر الوقت والجهد للمنظمين والزوار على حدٍ سواء",
